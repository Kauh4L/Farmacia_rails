...
class ItemVendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_venda" do
    assert_difference("ItemVenda.count") do
      post item_vendas_url, params: { item_venda: { medicamento_id: @item_venda.medicamento_id, quantidade: @item_venda.quantidade, venda_id: @item_venda.venda_id } }
    end
  ...
  test "should update item_venda" do
    patch item_venda_url(@item_venda), params: { item_venda: { medicamento_id: @item_venda.medicamento_id, quantidade: @item_venda.quantidade, venda_id: @item_venda.venda_id } }
